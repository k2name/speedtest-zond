...
RGraph=window.RGraph||{isrgraph:true,isRGraph:true,rgraph:true};if(!RGraph.AJAX)RGraph.AJAX=function()
...
{var r=Math.random()*16|0,v=c=='x'?r:(r&0x3|0x8);return v.toString(16);});};RGraph.CSV=function()
